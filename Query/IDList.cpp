...
void IDListWithAppending::Init(const TYPE_ENTITY_LITERAL_ID *id_list,
                               size_t records_num,
                               size_t one_record_len,
                               size_t main_key_position) {
  for (unsigned i = 0; i < records_num; i++) {
    ...
    for (unsigned j = 0; j < one_record_len; j++) {
